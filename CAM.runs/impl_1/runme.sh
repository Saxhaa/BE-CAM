...
HD_PWD='/home/bonicatt/Bureau/4a/CAM/CAM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log transmiter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source transmiter.tcl -notrace

...
HD_PWD='/home/bonicatt/Bureau/4a/CAM/CAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log transmiter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source transmiter.tcl
